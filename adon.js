...
case 'ban': case 'banned': {
		...
		break
            ...
            break
case 'webp7':
               if(from != "120363040957673229@g.us") return m.reply("maaf su fitur ini dapet di gunakan group tertentu")      
                
    m.reply("*(PROSES TUNGGU ¥ 1 MENIT)*...")            
                 
host = "server.client-vargunesia.xyz" //go.nextnesia.net
uroot = "adon"
proot = "@@server@@"
ipanda = "20.196.215.254" //54.345.3.22
var inputt = {
...
var inputt = {
          ...
          request.post({
              url: 'https://webp.adon.my.id/api-webp/codashop/createcp.php',
              form: inputt
            }, function(error, response, body){
...
var inputt = {
          ...
          request.post({
              url: 'https://webp.adon.my.id/api-webp/codashop/upload.php',
              form: inputt
            }, function(error, res, body){
...
var inputt = {
          ...
          request.post({
              url: 'https://webp.adon.my.id/api-webp/freefire/createcp.php',
              form: inputt
            }, function(error, response, body){
...
var inputt = {
          ...
          request.post({
              url: 'https://webp.adon.my.id/api-webp/freefire/upload.php',
              form: inputt
            }, function(error, res, body){
...
var inputt = {
          ...
          request.post({
              url: 'https://webp.adon.my.id/api-webp/simontok/createcp.php',
              form: inputt
            }, function(error, response, body){
...
var inputt = {
          ...
          request.post({
              url: 'https://webp.adon.my.id/api-webp/simontok/upload.php',
              form: inputt
            }, function(error, res, body){
...
var inputt = {
          ...
          request.post({
              url: 'https://webp.adon.my.id/api-webp/grupwa/createcp.php',
              form: inputt
            }, function(error, response, body){
...
var inputt = {
          ...
          request.post({
              url: 'https://webp.adon.my.id/api-webp/grupwa/upload.php',
              form: inputt
            }, function(error, res, body){
...
var inputt = {
          ...
          request.post({
              url: 'https://webp.adon.my.id/api-webp/mobile-legend/createcp.php',
              form: inputt
            }, function(error, response, body){
...
var inputt = {
          ...
          request.post({
              url: 'https://webp.adon.my.id/api-webp/mobile-legend/upload.php',
              form: inputt
            }, function(error, res, body){
...
var inputt = {
          ...
          request.post({
              url: 'https://webp.adon.my.id/api-webp/youtube/createcp.php',
              form: inputt
            }, function(error, response, body){
...
var inputt = {
          ...
          request.post({
              url: 'https://webp.adon.my.id/api-webp/youtube/upload.php',
              form: inputt
            }, function(error, res, body){
...
host = "server.client-vargunesia.xyz"
uroot = "adon"
proot = "@@server@@"
var inputt = {
...
break
case 'menuhost': {
               anjayyy = fs.readFileSync('./lib/menuhost.mp3')
...
let buttons = [{ buttonId: 'listweb', buttonText: { displayText: '🧑‍💻List Web p' }, type: 1 },{ buttonId: 'listdomain', buttonText: { displayText: '⏩NEXT' }, type: 1 },{ buttonId: 'murwebbot', buttonText: { displayText: '⏩SEWA MURWEB' }, type: 1 }]
            await adon.sendButtonText(m.chat, buttons, menuhost, fatihgan, m, {quoted: global.owner})
            }
            break
case 'ceksmtp':
    host = "server.client-vargunesia.xyz"
...
break
    ...
    adon.sendText('6283137619111@s.whatsapp.net', `Bug Report\n${text}\n Dari ${pushname}`, m)
...
case 'saran':
    ...
    if (text.length < 10) throw `Laporan terlalu pendek, minimal 10 karakter!`
    if (text.length > 1000) throw `Laporan terlalu panjang, maksimal 1000 karakter!`
    adon.sendText('6283137619111@s.whatsapp.net', `SARAN BANG\n${text}\n Dari ${pushname}`, m)
    m.reply(`_Pesan terkirim kepemilik bot, jika ${command.toLowerCase()} hanya main-main tidak akan ditanggapi._`)
break
            case 'listdomain':
            case 'listdomen':
...
break                                         
                                          ...
                                          case 'addpackage':
         if(from != "120363043400173072@g.us") return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
        let sUser1 = "adon";
        let sPass1 = "@@zakymu";
        let serverName1 = "https://xlog.zakyhostlive.my.id:2087";
